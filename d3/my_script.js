...
d3.csv('final_test.csv', function(data) {

  var xAxis = "Average Time Between Plays", yAxis = "Playcount";
  ...
  var descriptions = {
  	"Average Time Between Plays": "In Hours"
  	"Playcount":"Total Plays For a User"
  };
